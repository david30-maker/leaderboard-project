...
/***/ "./src/modules/game-api.js":
/*!*********************************!*\
  !*** ./src/modules/game-api.js ***!
  \*********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Api)\n/* harmony export */ });\nclass Api {\n  constructor() {\n    this.url = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/3CUiovNa2kz3xjn8Fnr/scores';\n  }\n  getScores = async () => {\n    const {\n      result\n    } = await fetch(this.url).then(response => response.json()).catch(err => new Error(err));\n    return result;\n  };\n  addScore = async data => {\n    await fetch(this.url, {\n      method: 'POST',\n      body: JSON.stringify(data),\n      headers: {\n        'Content-type': 'application/json; charset=UTF-8'\n      }\n    });\n  };\n}\n\n//# sourceURL=webpack://leaderboard/./src/modules/game-api.js?");
